...
<!--[if gt IE 9]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <script src="{{ url('backend/js/vendor/modernizr-3.3.1.min.js') }}"></script>
    ...
    <body>
                        ...
                        <ul class="nav navbar-nav-custom pull-right">
                            ...
                            <li class="dropdown">
                                <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="{{ url('backend/img/placeholders/avatars/avatar9.jpg') }}" alt="avatar">
                                </a>
        ...
        <script src="{{ url('backend/js/vendor/jquery-2.2.4.min.js') }}"></script>
        ...
        <script src="{{ url('backend/js/pages/readyDashboard.js') }}"></script>
        @yield('addJs')
